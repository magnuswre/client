...
let button3 = document.getElementById("btn1")
...
button3.addEventListener("click", ()=>{ // 07:00 i sprint 13 () Man behöver inte ge ett namn i parentesen om det bara används en gång
